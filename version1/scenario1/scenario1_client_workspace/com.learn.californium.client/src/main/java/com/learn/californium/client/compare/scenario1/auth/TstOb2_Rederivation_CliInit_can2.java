package com.learn.californium.client.compare.scenario1.auth;
...
public class TstOb2_Rederivation_CliInit_can2 {
	...
	public static void main(String[] args) throws OSException {
        ...
        // InMemoryMessageExchangeStore 中 findByToken 将会根据 token的长度 来判断scope, 然而 long_term是8个, 所以这里需要8个字符来转换成8个bytes
		String str_token1 = "clientA1";
		byte[] token1 = str_token1.getBytes();
		//byte[] token1 = {0x0F, 0x1F, 0x2F, 0x3F, 0x4F, 0x5F, 0x6F, 0x7F};
        byte[] token2 = {0x0F, 0x1F, 0x2F, 0x3F, 0x4F, 0x5F, 0x6F, 0x71};
        //因为我们要用 TokenGenerator.Scope.LONG_TERM 这种类型, 所以我们需要 根据 RandomTokenGenerator 中的createToken 方法 来参考
        token1[0] |= 0b1;	//所以需要做这个运算
		System.out.println(token1);

		TokenGenerator tokenGenerator2 = new RandomTokenGenerator(Configuration.createStandardWithoutFile());
